...
**Sprint 2 (Week 3-4): Academy Engine**
...
### Decision 2: ~~How many Cards at launch?~~ RESOLVED (v5)

Cards as a standalone product is out of scope for Learn v1 (being reworked separately). The "tools" layer is the prompt library itself — employees try use cases by running prompts in context. The shipped prompt template library (12-15 templates) serves as the curated set of "starter tools."
...
**What remains:** Use Case Generator → Academy + Certificates + Analytics → Dashboard + Polish + Pilot
